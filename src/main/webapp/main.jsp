        ...
        <div class="col-md-6 column">
            <div class="listTabSiz col-xs-3">
                <ul class="nav nav-tab vertical-tab tab_backgroundColor listTab" role="tablist">
                    ...
                    <li role="presentation">
                        <a href="#tab3" class="text-center textSize" aria-controls="inbox1" role="tab" data-toggle="tab">
                            <img src="png/air.png" class="imgSize"><br>
                            航班动态
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="#tab4" class="text-center textSize" aria-controls="inbox2" role="tab" data-toggle="tab">
            ...
            <div class="tab-content vertical-tab-content col-xs-9">
                <div role="tabpanel" class="tab-pane active" id="tab1">
                    <%--查询航班的，用于订票--%>
                    <form class="form-horizontal" role="form" method="post" action="/test" name="bookForm" onsubmit="return notNull()">
                        <div class="form-group">
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="dcityName" name="dcityName" placeholder="出发城市">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="tcityName" name="tcityName" placeholder="到达城市" data-container="body" data-toggle="popover" data-placement="bottom">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-10">
                ...
                <div role="tabpanel" class="tab-pane" id="tab2">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="#">
                        <div class="form-group">
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="passName" name="passName" placeholder="请输入乘机人姓名">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="passPhone" name="passPhone" placeholder="请输入乘机人手机号">
                            </div>
                        </div>
                        <div class="btn_right size">
