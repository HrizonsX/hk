// var province = [{"cityCode":"xmn","cityName":"厦门"},{"cityCode":"shah","cityName":"上海"},{"cityCode":"bjs","cityName":"北京"}];
var province;
$(function () {
	$.ajax({
		type: "POST",
...
function SelCity(obj, e) {
	var ths = obj;
	var dal =
		'<div class="_citys"><span title="关闭" id="cColse" >×</span><div id="_citysheng" class="_citys0">请选择城市</div><div id="_citys0" class="_citys1"></div><div style="display:none" id="_citys1" class="_citys1"></div><div style="display:none" id="_citys2" class="_citys1"></div></div>';
	Iput.show({
		id: ths,
		event: e,
		content: dal,
	...
	for (var i = 0,
		...
		tb_province.push('<a data-id="' + b[i]['cityCode'] + '" data-name="' + b[i]['cityName'] + '" title="' + b[i][
			'cityName'
		] + '">' + b[i]['cityName'] + '</a>')
	}
